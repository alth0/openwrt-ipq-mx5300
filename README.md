...
| [24.10-nss-custom](https://github.com/qosmio/openwrt-ipq/tree/24.10-nss)               |6.12.6|Current with upstream `openwrt-24.10` (next stable release) Also includes LuCI, nano, irqbalance and htop by default.|
